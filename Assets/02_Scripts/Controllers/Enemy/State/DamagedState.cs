...
{
    public DamagedState(Player player, Monster monster, Stat stat) : base(player, monster, stat) { }
    public override void OnStateEnter()
    {
        ...
        _monster.StartCoroutine(_monster.StartDamege(_player._playerStat.ATK, _monster.transform.position, 0.5f, 0.5f));
    }
